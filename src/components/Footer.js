  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      if (secondDiv) {
        ...
        setScrollWithSecondDiv(secondDivPosition <= window.innerHeight);
      }
    };
          ...
          <div className="flex justify-evenly items-center">
            ...
            <div className="px-6 py-1 bg-gray-300 rounded-lg shadow-md cursor-pointer flex items-center gap-1 justify-center">
              ...
              <div className="">
                ...
                <p className="font-bold text-xl tracking-wider">03300 432 801</p>
      ...
      <div className="second-div">
        <div className="bg-blue-gray-50 p-5">
          <div className="md:flex md:justify-between mx-[9%] py-6">
            ...
            <div>
              <h2 className="mt-5 md:mt-0 text-sm font-semibold text-gray-400 uppercase ">
                Legal
              </h2>
